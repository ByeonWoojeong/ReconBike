...
public class PoiDTO {
    ...
    public PoiDTO(String desc, String lowerAddrName, String secondNo, String parkFlag, String detailInfoFlag, String roadName, String id, String rpFlag, String noorLat, String name, String bizName, String telNo, String upperBizName, String noorLon, String lowerBizName, String firstBuildNo, String detailBizName, String frontLon, String frontLat, String secondBuildNo, String upperAddrName, String middleBizName, String radius, String detailAddrName, String middleAddrName, String firstNo) {
        this.desc = desc;
        this.lowerAddrName = lowerAddrName;
        this.secondNo = secondNo;
        this.parkFlag = parkFlag;
    ...
    public String toString() {
        return "PoiDTO{" +
                ...
                ", firstBuildNo='" + firstBuildNo + '\'' +
                ", detailBizName='" + detailBizName + '\'' +
                ", frontLon='" + frontLon + '\'' +
                ", frontLat='" + frontLat + '\'' +
                ", secondBuildNo='" + secondBuildNo + '\'' +
                ", upperAddrName='" + upperAddrName + '\'' +
                ", middleBizName='" + middleBizName + '\'' +
                ", radius='" + radius + '\'' +
                ", detailAddrName='" + detailAddrName + '\'' +
                ", middleAddrName='" + middleAddrName + '\'' +
                ", firstNo='" + firstNo + '\'' +
                '}';
    }
}
