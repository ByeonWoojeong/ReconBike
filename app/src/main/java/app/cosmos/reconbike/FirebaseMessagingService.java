...
import static app.cosmos.reconbike.GlobalApplication.getOtherLogin;
...
public class FirebaseMessagingService extends com.google.firebase.messaging.FirebaseMessagingService {
    ...
    private void sendNotificationText(String text, String link) {
        ...
        notificationBuilder.setContentTitle("리콘바이크")
                .setContentText(text)
                .setAutoCancel(true)
    ...
    private void sendNotificationImage(String text, String image, String link) {
        ...
        try {
            ...
            notificationBuilder.setContentTitle("리콘바이크")
                    ...
                    .setVibrate(new long[] { 1000, 1000, 1000, 1000, 1000 })
                    .setLights(Color.RED, 3000, 3000)
                    .setStyle(new NotificationCompat.BigPictureStyle().bigPicture(getBitmap).setBigContentTitle("리콘바이크").setSummaryText(text))
                    .setContentIntent(pendingIntent);
            NotificationManager notificationManager = (NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);
            notificationManager.notify(0, notificationBuilder.build());
        } catch (Exception e) {
