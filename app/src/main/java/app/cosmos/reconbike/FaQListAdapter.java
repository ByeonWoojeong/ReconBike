...
public class FaQListAdapter extends BaseExpandableListAdapter {
    ...
    public FaQListAdapter(Context context, ExpandableListView list, int layout, int layout2, ArrayList<FaQ> data, ArrayList<ArrayList<FaQ>> data2) {
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (list.isGroupExpanded(groupPosition)) {
            finalHolder.faq_arrow.setImageResource(R.drawable.arrow_up);
            finalHolder.faq_title.setTextColor(Color.parseColor("#eb1453"));
        } else {
            finalHolder.faq_arrow.setImageResource(R.drawable.arrow_down);
            finalHolder.faq_title.setTextColor(Color.parseColor("#333333"));
        }
